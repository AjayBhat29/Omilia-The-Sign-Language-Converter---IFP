...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  3 18:48:45 2021
...
def text_mode(cam):
	...
	while True:
		...
		keypress = cv2.waitKey(1)
		if(thresh_flag == True):
			img_name = "Thresh__{}.png".format(0)
			cv2.imwrite(img_name, thresh)
			thresh_flag = False
		if(blackboard_flag == True):
			img_name = "BlackBoard__{}.png".format(0)
			cv2.imwrite(img_name, blackboard)
			blackboard_flag = False
		if(res_flag == True):
			img_name = "Result__{}.png".format(0)
